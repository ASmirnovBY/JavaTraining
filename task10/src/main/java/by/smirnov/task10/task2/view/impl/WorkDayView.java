...
public class WorkDayView extends ConsoleView {


   public WorkDayView(Scanner in) {
        super(in);
    }
    ...
    public Request buildRequest() {
        ...
        request.setCommand(ViewType.BUILD_WORK.toString());
        String year = in.next();
    ...
    public void printResponse(Response response) {
        if (response.getStatus()
            ...
            calendar.getWorkDays().forEach(dayOfCalendar -> {
